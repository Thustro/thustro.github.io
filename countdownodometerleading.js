(function () {
  ...
  Odometer = (function () {
    ...
    Odometer.prototype.resetFormat = function () {
      ...
      precision =
        fractional + (fractional2 != null ? fractional2.length : void 0) || 0;
      return (this.format = {
        repeating: repeating,
        radix: radix,
        precision: precision,
    ...
    Odometer.prototype.formatDigits = function (value) {
      ...
      if (this.options.formatFunction) {
        ...
        minIntegerLen =
          (_ref1 = this.options.minIntegerLen) != null
            ? _ref1
            : MIN_INTEGER_LEN;
        for (
          i = _j = _ref2 = i - fractionalCount;
          _j < minIntegerLen;
          i = _j += 1
        ) {
    ...
    Odometer.prototype.animateSlide = function (newValue) {
      ...
      minIntegerLen =
        (_ref = this.options.minIntegerLen) != null ? _ref : MIN_INTEGER_LEN;
      digitCount = Math.max(
        this.getDigitCount(oldValue, newValue),
        minIntegerLen + fractionalCount
      );
      digits = [];
      boosted = 0;
      for (
